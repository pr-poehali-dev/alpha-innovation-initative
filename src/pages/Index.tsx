      ...
      <section className="bg-black py-20 px-6 sm:px-12 lg:px-24">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative border-l-2 border-orange-500/40 pl-8 space-y-10">
            {[
              { year: "1944", text: "Депортация чеченского народа по приказу Сталина в Казахстан и Сибирь. Погибло от 25 до 50% депортированных." },
              { year: "1957", text: "Реабилитация чеченцев при Хрущёве. Возвращение на родину, восстановление Чечено-Ингушской АССР." },
